...
export default function AiHumanCta() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:py-16 md:px-6">
      <div className="bg-cc-charcoal dark:text-foreground text-background border-border flex flex-col items-center rounded-2xl border px-6 py-12 text-center sm:px-12 sm:py-16 md:flex-row">
        <div className="flex-1">
          ...
          <LinkButton
            href="#"
            className="mt-10 w-full rounded-full p-5 text-white md:mt-12 md:w-fit md:p-6"
          >
            <HugeiconsIcon
              strokeWidth={1.75}
          ...
          {RATINGS.map((item) => (
            <div key={item.label} className="w-full">
              ...
              <div className="bg-input mt-2 h-1.75 overflow-hidden rounded-full sm:h-2 md:mt-3">
                <div
                  className="bg-cc-sage-900 h-full"
