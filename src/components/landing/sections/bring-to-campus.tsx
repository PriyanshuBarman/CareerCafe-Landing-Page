        ...
        <Card className="border-cc-sage-700 dark:text-foreground text-background grid gap-18 rounded-4xl border bg-transparent p-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-12 flex flex-wrap items-center gap-4">
              ...
              <Button
                variant="ghost"
                className="border-cc-sage-700 dark:text-cc-sage-500 text-cc-sage-500 hover:text-cc-sage-500 w-full flex-1 border p-5 text-xs hover:bg-transparent sm:p-6 sm:text-sm"
              >
